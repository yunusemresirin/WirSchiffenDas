...
\usepackage[a4paper,left=2.2cm,right=2.2cm,top=2.15cm,bottom=2.2cm,headheight=15pt]{geometry}
\usepackage{lmodern}
...
\begin{tikzpicture}[baseline=-0.4ex,scale=0.64]
  ...
  \node[anchor=west,text=black,font=\sffamily\bfseries\large] at (1.55,0.10) {Hochschule};
  \node[anchor=west,text=black,font=\sffamily\bfseries\large] at (1.55,-0.28) {Bonn-Rhein-Sieg};
\end{tikzpicture}}
