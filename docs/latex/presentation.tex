...
\newcommand{\adrbadge}[1]{\reqbadge{darkblue}{#1}}
...
% --- Inhalt -----------------------------------------------------------------
\input{slides/01-einordnung.tex}
\input{slides/02-architektur.tex}
\input{slides/03-technische-anforderungen.tex}
\input{slides/04-adrs.tex}
\input{slides/05-demo-fazit.tex}
