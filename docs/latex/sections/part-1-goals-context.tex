...
\begin{tikzpicture}[
  ...
  actor/.style={draw,rounded corners,fill=lightgray,minimum width=34mm,minimum height=11mm,align=center},
  system/.style={draw=darkblue,rounded corners,fill=lightblue,minimum width=48mm,minimum height=12mm,align=center}
]
\node[actor] (eng) {Ingenieur};
\node[system,right=of eng] (ui) {React/MUI Frontend};
