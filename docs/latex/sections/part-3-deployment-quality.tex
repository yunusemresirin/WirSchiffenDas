...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{../diagrams/Verteilungssicht.jpeg}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{../diagrams/Bausteinsicht-monitoring.png}
