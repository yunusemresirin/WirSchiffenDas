...
\subsection{Priorisierte Probleme und Gegenmaßnahmen}
...
\begin{itemize}
  ...
  \item \textbf{Retry:} Nach Wiederherstellung wird nur der fehlgeschlagene Algorithmus erneut gestartet und die Kette anschließend fortgesetzt.
