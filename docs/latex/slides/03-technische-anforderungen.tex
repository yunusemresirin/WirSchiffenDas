...
ENTRYPOINT ["java", "-jar", "/app/app.jar"]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \begin{block}{Nachweis}
        \small 6 Backend-Dockerfiles; zusätzlich frontend/Dockerfile.
      \end{block}
    \end{column}
  \end{columns}
\end{frame}
...
services:
  ...
  analysis-management-service:
    ...
    \begin{column}{0.42\textwidth}
      \textbf{Erläuterung}
      \begin{itemize}
        \item Compose definiert sechs Backend-Services und web-ui, Ports, Umgebungsvariablen und getrennte Volumes.
        \item Services finden sich über \textbf{Service-Namen} im Netzwerk \code{wirschiffendas-network} -- keine fest verdrahteten IPs.
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.44\textwidth}
      \begin{block}{Begründung (ADR-02)}
        \small Für den kleinen PoC ist REST einfach nachvollziehbar, testbar und mit der Aufgabenstellung kompatibel. Kafka bleibt bewusst au\ss{}erhalb des Kernumfangs.
      \end{block}
      \vspace{0.2cm}
