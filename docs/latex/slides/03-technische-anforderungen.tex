...
% --- TA-03 -----------------------------------------------------------------
\begin{frame}[fragile,shrink=5]{TA-03 -- Docker Compose}
  \tabadge{TA-03}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.54\textwidth}
...
% --- TA-04 -----------------------------------------------------------------
\begin{frame}[fragile,shrink=3]{TA-04 -- Resilience4j: Circuit Breaker}
  \tabadge{TA-04}
  \begin{columns}[T,onlytextwidth]
  ...
  circuitbreaker:
    ...
    \begin{column}{0.46\textwidth}
      ...
      \begin{tikzpicture}[
        ...
        st/.style={draw=darkblue,rounded corners,fill=lightblue,minimum width=19mm,minimum height=6mm,align=center},
        op/.style={draw=warnorange,rounded corners,fill=warnorange!10,minimum width=19mm,minimum height=6mm,align=center}
      ]
      \node[st] (c) {Closed};
      \node[op,right=of c] (o) {Open};
      \node[st,right=of o] (h) {Half-Open};
      \draw[-{Latex},thick] (c) -- node[above]{Fehler} (o);
      \draw[-{Latex},thick] (o) -- node[above]{10s} (h);
      \draw[-{Latex},thick] (h) to[bend left=35] node[below]{Erfolg} (c);
      \end{tikzpicture}
      \end{center}
